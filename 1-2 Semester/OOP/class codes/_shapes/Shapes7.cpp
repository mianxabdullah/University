// shape objects, a confusing code
// solution: a pure virtual function, a functionality in general not possible, but for specific
...
int mainShapes()
{
	...
	Shape *s1 = new Shape("S1", "Square", 1, blue, pink);
	cout << "Square created with a point composed" << endl;
	Shape *r1 = new Shape("R2", "Rectangle", 1, yellow, red);
	cout << "Rectangle created with a point composed" << endl;
	Shape *c1 = new Shape("C1", "Circle", 5, red, green);
	cout << "Circle created with a point composed" << endl;
	Shape *r2 = new Shape("R3", "Rectangle", 0, blue, pink);
	cout << "Rectangle created with a point composed" << endl;
	Shape *c2 = new Shape("C2", "Circle", 1, pink, red);
	cout << "Circle created with a point composed" << endl;
