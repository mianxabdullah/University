...
int main()
{
	...
	Rectangle *r2 = new Rectangle("R1", "Rectangle", 2, blue, pink, o, 4, 3);
	Rectangle *r3 = new Rectangle("R1", "Rectangle", 2, blue, pink, o, 4, 3);
	Rectangle *r4 = new Rectangle("R1", "Rectangle", 2, blue, pink, o, 4, 3);
	cout << "Rectangles created with a point composed" << endl;
	...
	c->addShape(r4);
	c->addShape(r2);
	cout << "Rectangles are aggregated in canvas" << endl;
